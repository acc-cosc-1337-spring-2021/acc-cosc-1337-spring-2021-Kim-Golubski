...
TEST_CASE("test get_letter_grade_using_if", "accept a number grade and return letter grade")
 {
	...
	REQUIRE(get_letter_grade_using_if(123) == "Number out of range");
}

TEST_CASE("test get_letter_grade_using_switch", "accept a number grade and return letter grade")
 {
	...
	REQUIRE(get_letter_grade_using_switch(123) == "Number out of range");
}